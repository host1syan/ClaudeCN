...
> 让 ClaudeCN 跨会话记住你是谁、你偏好什么、项目正在发生什么。
...
ClaudeCN 的记忆系统是一套**基于文件的持久化知识库**，让 Claude 能够跨越多次对话，持续积累对你和你的项目的理解。
...
ClaudeCN 有一个隐藏的 **AutoDream** 功能，类比人类睡眠时大脑整理记忆的过程。当满足以下条件时，Claude 会在后台静默启动一个"做梦"子智能体：
