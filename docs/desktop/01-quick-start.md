...
侧边栏是你与 ClaudeCN 交互的导航中心：

- **品牌区域**：显示「ClaudeCN」标识，点击 GitHub 图标跳转仓库
- **操作按钮**：
  - `+` 新建会话
  - 时钟图标 → 定时任务管理
  - 齿轮图标 → 设置页面
...
ClaudeCN 在执行文件修改、Shell 命令等操作前，会请求你的权限。
...
桌面端支持创建 **Cron 定时任务**，让 ClaudeCN 按计划自动执行。
