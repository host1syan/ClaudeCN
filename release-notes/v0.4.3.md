...
| 平台 | 文件 |
|------|------|
| macOS Apple Silicon（M 系列） | `Claude-Code-Cn-0.4.3-mac-arm64.dmg` |
| macOS Intel | `Claude-Code-Cn-0.4.3-mac-x64.dmg` |
| Windows x64 | `Claude-Code-Cn-0.4.3-win-x64.exe` |
| Linux x64 | `Claude-Code-Cn-0.4.3-linux-x86_64.AppImage` 或 `Claude-Code-Cn-0.4.3-linux-amd64.deb` |
| Linux ARM64 | `Claude-Code-Cn-0.4.3-linux-arm64.AppImage` 或 `Claude-Code-Cn-0.4.3-linux-arm64.deb` |
...
```bash
chmod +x Claude-Code-Cn-0.4.3-linux-x86_64.AppImage
./Claude-Code-Cn-0.4.3-linux-x86_64.AppImage
```

deb：

```bash
sudo apt install ./Claude-Code-Cn-0.4.3-linux-amd64.deb
```
